...
This repository contains a Jupyter Notebook (`P2_01_notebook.html`) detailing an **Exploratory Data Analysis (EDA)** of the World Bank's Education Statistics (EdStats) dataset. The primary goal of this analysis is to provide strategic insights to an EdTech company, helping them identify and prioritize international markets with the highest client potential for their services.
